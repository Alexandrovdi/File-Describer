...
Также для вашего удобства можно скачать готовый [файл base](https://github.com/Alexandrovdi/File-Describer/blob/main/docs/FileDB.base) который выведет полный список файлов с описанием. Воспользовавшись поиском вы быстро найдете нужный файл. 
...
### При удалении файла описания
**ВНИМАНИЕ!**
При удалении файла описания из папки (Notes subfolder) система предложит удалить файл - можно согласиться или нет. Если нет то плагин предложит обновить описание к файлу.
